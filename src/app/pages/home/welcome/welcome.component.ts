...
export class WelcomeComponent implements OnInit {
  ...
  randomRemember = [
    ...
    `<div>Hãy luôn ghi nhớ <h2 class="d-inline-block">"Phải tu hành mới thoát khỏi bạn tai"</h2> bạn nhé!</div>`,
    ...
    `<div><h2 class="d-inline-block">"Phải thương hại kẻ nghịch chứ cahwngr nên cừu hờn"</h2></div>`,
